...
class set_new_password_form(FlaskForm):
    ...
    confirm_new_password = PasswordField('Confirm Password:', render_kw={"placeholder": "Confirm Password"}, validators=[DataRequired(message="This field cannot be empty"), EqualTo('new_password', message='Passwords must match')])
